...
public class FloatingWidgetService extends Service implements View.OnClickListener {
    ...
    private View addRemoveView(LayoutInflater inflater) {
        ...
        removeFloatingWidgetView = inflater.inflate(R.layout.bubble_remove, null);
...
//        paramRemove.gravity = Gravity.TOP | Gravity.LEFT;
    ...
    private void addFloatingWidgetView(LayoutInflater inflater) {
        ...
        mFloatingWidgetView = inflater.inflate(R.layout.bubble_layout, null);
    ...
    private void onFloatingWidgetClick() {
        if (isViewCollapsed()) {
            ...
            Toast.makeText(this, "Camera Action Needed Now!", Toast.LENGTH_SHORT).show();
            //////////////////////////

            Toast.makeText(this, "Starting Capture", Toast.LENGTH_SHORT).show();
//            pictureService.startCapturing(this);

            Intent intent = new Intent(FloatingWidgetService.this, CameraActivity.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//            Camera = "takePicture";
//            intent.putExtra("doCamera", Camera);
            startActivity(intent);
